defmodule OpenAperture.Mixfile do
  ...
  defp deps do
    [
      ...
      {:openaperture_auth, git: "https://github.com/OpenAperture/auth.git", ref: "4fe353ee38c7369e2554304a5d460e4381b813ea", override: true},
      {:openaperture_messaging, git: "https://github.com/OpenAperture/messaging.git", ref: "bb4caba09def51ccb77edfe72899e6135010a322", override: true},
