defmodule OpenAperture.Manager.GitHub.Repo do
  @moduledoc """
  ...
  alias OpenAperture.Manager.GitHub
  ...
  ## Examples
    ...
    iex> OpenAperture.Manager.GitHub.Repo.get_project_name("https://github.com/test_user/test_project")
    "test_project"
  """
  ...
  ## Examples
    ...
    iex> OpenAperture.Manager.GitHub.Repo.get_github_repo_url("test_user/test_project")
