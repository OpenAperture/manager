...
#
# This module contains the queries associated with OpenAperture.Manager.DB.Models.ProductComponent
#
# == Contact
#
...
# License::   n/a
#
defmodule OpenAperture.Manager.DB.Queries.ProductComponent do
