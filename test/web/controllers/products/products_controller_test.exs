defmodule OpenAperture.Manager.ProductsController.Test do
  use ExUnit.Case
  use Plug.Test
  ...
  test "index action" do
    ...
    :meck.expect(OpenapertureManager.Repo, :all, 1, products)
  ...
  test "create action -- success" do
    ...
    :meck.expect(OpenapertureManager.Repo, :one, 1, nil)
    :meck.expect(OpenapertureManager.Repo, :insert, 1, product)
  ...
  test "delete action -- success" do
    product = %Product{name: "test1", id: 1}
    :meck.expect(OpenapertureManager.Repo, :one, 1, product)
    :meck.expect(OpenapertureManager.Repo, :delete, 1, product)
  ...
  test "update action -- success" do
    ...
    :meck.expect(OpenapertureManager.Repo, :one, fn query ->
    ...
    :meck.expect(OpenapertureManager.Repo, :update, 1, updated_product)
